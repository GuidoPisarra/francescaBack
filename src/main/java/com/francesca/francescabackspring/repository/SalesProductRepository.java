...
public interface SalesProductRepository extends JpaRepository<SalesProduct, Integer> {
    @Query("SELECT new com.francesca.francescabackspring.DTO.ReportSalesDay(s.id, sp.idProduct, sp.idSale, p.description, sp.quantity, (sp.quantity * p.salePrice),sp.SaleProductDate )" +
